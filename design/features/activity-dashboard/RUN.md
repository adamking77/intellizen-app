...
Earlier delivery verification was recorded here; the later Activity visual rejection and partial revised acceptance supersede that pass. Current receipt: VERIFICATION.md; the later full visual verification checkpoint supersedes the partial pass.
...
7. Adam authorized full visual verification of Capabilities and Activity after edits, then a GitHub commit. Independent native review found date-axis crowding, clipped Hermes descriptions, cramped Settings navigation and missing dismissal focus return. Fixed and reverified those findings, made global connection scope visible, passed the full frontend checks, and restored original preferences. Both pages passed the bounded native visual gate. Current evidence and limits: VERIFICATION.md and the local FULL-VISUAL-VERIFICATION.md report.
