...
export function WorkflowsView() {
  ...
  return <div className="relative flex h-full min-h-0 flex-col overflow-y-auto bg-[var(--base)] p-5">
    {editing ? <>
      ...
      <PageHeader title="Workflows" state="Create workflows, assign steps, and review results." action={<Control size="sm" variant="primary" onClick={() => newWorkflow()}><Plus size={14} aria-hidden />New workflow</Control>} />
      <div className="mt-5">
