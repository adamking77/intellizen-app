...
| Keep working while Adam is away | A delegated Docs task moved through the ordinary Tasks board and returned a Done receipt to its parent. | Child Task `7ca78b41-d224-4a94-aaed-442f25cebeb7`; parent Task `e2c487d6-74dd-4c5f-b57c-f33f89128eba`. The live scheduled-run example remains in the three-day acceptance scene. |
...
The examples prove the six capability classes. They do not replace Done
requirements 1 and 5: Adam's approved acceptance script still has to run
unchanged on three separate days.
